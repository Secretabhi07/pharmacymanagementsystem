...
class Login:
    def __init__(self, root):
        ...
        title = Label(frame, text='Welcome to PharmaMS', font=('times new roman', 20, 'bold'), bg='white', fg='blue')
    ...
    def login(self):
        ...
        if (username == "joe" or username == "jef" or username == "jay") and password == "Abhi123":
            ...
            messagebox.showerror("Login Error", "Login fail")
class PharmacyManagementSystem:
    def __init__(self,root):
        ...
        conn=mysql.connector.connect(host="localhost",username="root",password="Rajitbro",database="management")
